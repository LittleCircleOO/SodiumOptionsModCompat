...
import toni.sodiumoptionsmodcompat.foundation.config.AllConfigs;
...
public class SodiumOptionsModCompat #if FABRIC implements ModInitializer, ClientModInitializer #endif
{
    ...
    public void onInitialize() {
            ...
            AllConfigs.register((type, spec) -> {
                #if AFTER_21_1
                NeoForgeConfigRegistry.INSTANCE.register(SodiumOptionsModCompat.ID, type, spec);
                #else
                ForgeConfigRegistry.INSTANCE.register(SodiumOptionsModCompat.ID, type, spec);
                #endif
            });
        #endif
    }
    ...
    public void onInitializeClient() {
        #if AFTER_21_1
            #if FABRIC
            ConfigScreenFactoryRegistry.INSTANCE.register(SodiumOptionsModCompat.ID, ConfigurationScreen::new);
            #endif
        #endif
    }
